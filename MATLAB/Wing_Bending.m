...
I_shell = (55082.565563e-12/0.25) * chord; % Shell moment of inertia [m^4]
d_st = 0.003; % Distance btw Shell's Neutral Axis and Tube Neutral Axis [m]
E_shell = 2.54e9; % Elastic modulus of PLA [Pa]

I_shell_trasformed = I_shell + A_shell*d_st^2; % Transformed I of shell
...
deflection = (deflection - deflection(find(wing_y == 0, 1))).*1000;
...
% Plot deflection
subplot(2, 1, 2);
plot(wing_y, deflection, 'r-', 'LineWidth', 2);
grid on;
xlabel('Spanwise Position [m]');
